...
export const MonthlyPaymentProposal = ({
  ...
  const highestAPRDebt = debts.length > 0
    ? debts.reduce((prev, current) => (prev.apr > current.apr ? prev : current))
    : null;
  ...
  return (
    <>
      <Button
        ...
        variant="outline"
        className="w-full bg-gradient-to-r from-blue-50 to-blue-100 dark:from-blue-950 dark:to-blue-900 border-blue-200 dark:border-blue-800"
      >
