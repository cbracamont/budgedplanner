        ...
        {payments.length === 0 ? (
          ...
          <div className="space-y-3">
            {payments.map((payment) => {
              ...
              // Determine if payment is auto-generated (has "automático generado" in notes)
              const isAutoGenerated = payment.notes?.includes("automático generado") || payment.notes?.includes("Pago automático");
                ...
                >
                  <div className="flex items-center gap-3 flex-1">
                    ...
                    <div className="flex-1">
                      ...
                      {payment.notes && !isAutoGenerated && <p className="text-sm text-muted-foreground mt-1">{payment.notes}</p>}
