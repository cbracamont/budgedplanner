...
export const translations = {
  en: {
    ...
    receivedInvitationsDesc: "You have pending invitations to join households",
    accept: "Accept",
    reject: "Reject",
    sendNewInvitation: "Send New Invitation",
    inviteFamilyMembers: "Invite family members to join your household",
    emailAddress: "Email Address",
    role: "Role",
    viewerRole: "Viewer - Can only view data",
    contributorRole: "Contributor - Can add their own data",
    editorRole: "Editor - Can edit all data",
    sendInvitation: "Send Invitation",
    yourHouseholdInvitations: "Your Household Invitations",
    shareCodesDesc: "Share these codes with family members to invite them",
    noInvitations: "No Invitations",
    noInvitationsDesc: "Enter a code above to join a household or wait for an invitation",
    householdMemberInfo: "You're a Household Member",
    householdMemberInfoDesc: "Only the household owner can send invitations to new members",
    // Settings panel
    ...
    generalSettingsDesc: "Customize your experience in the app",
    currencyLabel: "Currency",
    selectCurrency: "Select a currency",
    currencyHelp: "This will be the currency used to display all monetary values",
    // Audit log
    changeHistory: "Change History",
    changeHistoryDesc: "Log of all modifications made",
  ...
  es: {
    ...
    receivedInvitationsDesc: "Tienes invitaciones pendientes para unirte a hogares",
    accept: "Aceptar",
    reject: "Rechazar",
    sendNewInvitation: "Enviar Nueva Invitación",
    inviteFamilyMembers: "Invita a miembros de la familia a unirse a tu hogar",
    emailAddress: "Correo Electrónico",
    role: "Rol",
    viewerRole: "Visor - Solo puede ver datos",
    contributorRole: "Contribuidor - Puede agregar sus propios datos",
    editorRole: "Editor - Puede editar todos los datos",
    sendInvitation: "Enviar Invitación",
    yourHouseholdInvitations: "Invitaciones de tu Hogar",
    shareCodesDesc: "Comparte estos códigos con familiares para invitarlos",
    noInvitations: "Sin Invitaciones",
    noInvitationsDesc: "Ingresa un código arriba para unirte a un hogar o espera una invitación",
    householdMemberInfo: "Eres Miembro del Hogar",
    householdMemberInfoDesc: "Solo el propietario del hogar puede enviar invitaciones a nuevos miembros",
    ...
    generalSettingsDesc: "Personaliza tu experiencia en la aplicación",
    currencyLabel: "Moneda",
    selectCurrency: "Selecciona una moneda",
    currencyHelp: "Esta será la moneda utilizada para mostrar todos los valores monetarios",
    changeHistory: "Historial de Cambios",
    changeHistoryDesc: "Registro de todas las modificaciones realizadas",
    noChangesYet: "No hay cambios registrados aún",
    changes: "Cambios",
    user: "Usuario",
    created: "Creó",
    edited: "Editó",
  ...
  pt: {
    ...
    generalSettingsDesc: "Personalize sua experiência no aplicativo",
    currencyLabel: "Moeda",
    selectCurrency: "Selecione uma moeda",
    currencyHelp: "Esta será a moeda usada para exibir todos os valores monetários",
    changeHistory: "Histórico de Alterações",
    changeHistoryDesc: "Registro de todas as modificações realizadas",
    noChangesYet: "Nenhuma alteração registrada ainda",
    changes: "Alterações",
    user: "Usuário",
    created: "Criou",
    edited: "Editou",
