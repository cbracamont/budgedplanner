          ...
          {pieData.length > 0 && (
            <Card className="overflow-hidden">
              <CardHeader className="pb-3">
                ...
                <CardDescription className="text-sm">Monthly spending distribution</CardDescription>
              </CardHeader>
              <CardContent className="p-0">
                  ...
                  <div className="relative flex items-center justify-center">
                    <div className="relative w-56 h-56 md:w-64 md:h-64">
                      ...
                      <svg viewBox="0 0 36 36" className="w-full h-full transform -rotate-90">
                        ...
                        {/* Círculo central */}
                        <circle cx="18" cy="18" r="10" fill="white" className="dark:fill-slate-900" />
                      </svg>
                  ...
                  <div className="flex flex-col justify-center space-y-4">
                    {pieData.map((d, i) => {
                      ...
                      return (
                        <div
                          key={i}
                          className="flex items-center justify-between p-3 rounded-lg bg-slate-50 dark:bg-slate-800/50 transition-all hover:bg-slate-100 dark:hover:bg-slate-700/50 cursor-default"
                        >
                          <div className="flex items-center gap-3">
                ...
                <div className="border-t px-6 py-4 bg-gradient-to-r from-slate-50 to-slate-100 dark:from-slate-800 dark:to-slate-900">
...
const DebtPlanner = ({
  ...
  const { totalIncome, totalFixed, totalVariable, totalDebtPayment, totalExpenses, cashFlow, savingsTotal } =
    ...
    }, [debtData, incomeData, fixedExpensesData, variableExpensesData, savings]);
