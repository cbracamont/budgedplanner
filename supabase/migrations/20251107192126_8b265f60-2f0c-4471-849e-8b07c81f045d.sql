-- First, drop any existing triggers if they exist
DROP TRIGGER IF EXISTS update_debt_balance_trigger ON public.debt_payments;
DROP TRIGGER IF EXISTS restore_debt_balance_trigger ON public.debt_payments;
